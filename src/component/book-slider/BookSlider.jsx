...
const BookSlider = ({data}) => {
    ...
    <div className="book-slider-container">
        ...
        <div style={{transform: `translateX(${slideIndex * -340}px)`}} className="book-slider-wrapper">
            ...
            {data.map(item =>
            <div key={item.id} className="book-slide-itme">
        ...
        {slideIndex <= data.length - 1 && <i onClick={() => handleClick('right')} className="bi bi-chevron-right left book-slider-arrow-right"></i>}
